...
5.  **`combined` (Default)
    *   **Goal:** Block based on meeting a sufficient number of key conditions: sustained activity (TimeSpan), significant volume (TotalReq vs effective_min), and high average request rate (Req/Min(Win)).
